...
```sh
git clone git@github.com:zlh20040308/feng-chisel-template.git
cd feng-chisel-template
```
...
#### Commit your changes
```sh
git commit -m 'Starting feng-chisel-template'
...
```sh
mill feng-chisel-template.test
```
